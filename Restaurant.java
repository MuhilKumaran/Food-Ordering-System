...
public class Restaurant {
	...
	public static void main(String[] args) throws InvalidOptionException, ItemNotFoundException {
		...
		while(!option.equals("exit"))
		{
			...
			if(choice>='A' && choice<='F')
			{
				...
				{
					System.out.println("Enter FoodName to remove : ");
					String removeFood=sc.nextLine();
					res.map.remove(removeFood);
				}
				
				else if(choice=='C')
				{
					System.out.println("Enter Food Name to Update Quantity : ");
					String UpdateFood=sc.nextLine();
					System.out.println("Enter The quantity : ");
					int UpdateQuantity=sc.nextInt();
					sc.nextLine();
					res.map.put(UpdateFood, UpdateQuantity);
				}
				...
				else if(choice=='D')
				{
					...
					else 
					{
						...
						{
							System.out.println("Item Name = "+entry.getKey()+"    ItemQuantity = "+entry.getValue());
						}
					}
				}
